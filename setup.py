    ...
    if cythonize_switch:
        ...
        ext_modules = cythonize(
            [
                ...
                Extension(
                    "pyearth._basis", ["pyearth/_basis.pyx"], include_dirs=[numpy_inc]
                ),
                Extension(
                    "pyearth._record", ["pyearth/_record.pyx"], include_dirs=[numpy_inc]
                ),
                Extension(
                    "pyearth._pruning",
        ...
        ext_modules = [
            ...
            Extension(
                "pyearth._record", ["pyearth/_record.c"], include_dirs=[numpy_inc]
            ),
            Extension(
                "pyearth._pruning",
                ["pyearth/_pruning.c"],
            ...
            Extension(
                "pyearth._qr", ["pyearth/_qr.c"], include_dirs=[local_inc, numpy_inc]
            ),
            Extension(
                "pyearth._types",
                ["pyearth/_types.c"],
